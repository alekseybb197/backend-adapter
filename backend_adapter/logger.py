...
def _write(msg: str) -> None:
    ...
    v0.9.8: значение сессии — СНИМОК общих флагов, взятый при её образовании;
    запрос без заголовка сессии (UNKNOWN_SESSION_ID) в файл не пишется вовсе
    (гейт в session_log.logging_enabled) — ранний выход ниже остаётся как
    дешёвая отсечка до похода в session_settings.
