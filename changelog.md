...
## v0.9.6 — шесть улучшений: responses→responses + `/model`, перманентный `state.yaml`, валидация env/YAML, дробные тарифы, таблица сессий, связка Log/Parts

### 2026-09-13 Саммари ветки v0.9.6 (6 задач)
...
таблица сессий компактнее; Parts больше не «висит» без Log. Рабочее дерево —
ветка `feature/v0.9.6` в режиме WIP.
...
Рабочее дерево — ветка `feature/v0.9.5` в режиме WIP.
