...
## v0.9.8 — снимок Log/Parts при образовании сессии; санитайзер `max_tokens`

### 2026-09-15 Саммари ветки v0.9.8 (5 коммитов между merge PR #20 (v0.9.7) и снятием WIP)

**Цель:** сделать логирование и сбор частей **строго пер-сессионными**
функциями и защитить адаптер от пробинга лимита ответа клиентом.
...
инцидентов, JSON проверок бэкендов, PID-файл).

Детали — `docs/logging.md` («Пер-сессионные гейты логирования»),
`docs/webui.md` §4, `docs/routing.md` §2.4, `docs/environment.md`,
`docs/architecture.md` §6.11/§8.
