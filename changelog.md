...
## v0.9.3 (WIP — install.sh: molecule-тест (Linux, latest, ubuntu 24.04), системный systemd-сервис `--service`, режим `--delete`, авто-обновление при повторной установке + фикс verify())
