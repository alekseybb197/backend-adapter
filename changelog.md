...
## v0.9.8 — снимок Log/Parts при образовании сессии; санитайзер `max_tokens`; превью `.err` в WEBUI; информативный баннер бэкендов; гайд Codex CLI

### 2026-09-15 Саммари ветки v0.9.8 (8 коммитов между merge PR #20 (v0.9.7) и снятием WIP)
...
`docs/architecture.md` §6.11/§6.12/§8, `docs/codex.md`, `docs/install.md`
(«Ожидаемый вывод»).
