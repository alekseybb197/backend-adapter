...
## v0.8.6 (WIP — тарифы моделей с колонкой Cost, пересмотр флагов логирования и WEBUI, корректное завершение по Ctrl-C/SIGTERM, Cost в live-поллинге, верхняя «Свернуть», тесты graceful shutdown и интеграционного прогона, favicon на производных страницах, удаление tmp/check_v086.py, README)
