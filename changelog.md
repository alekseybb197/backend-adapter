...
## v0.9.5 — сессия как единица управления: страница `/sessions`, пер-сессионные Log/Parts/TARGET, `.err` для любой учтённой ошибки

### 2026-09-12 Саммари ветки v0.9.5 (7 задач)
...
процесса (перезапуск начинает их заново). Рабочее дерево — ветка
`feature/v0.9.5` в режиме WIP.
