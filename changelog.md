...
## v0.7.3 (дистрибуция адаптера) — WIP (накопление в build/v0.7.3)

### 2026-09-04 Ветка `build/v0.7.3` — настройка дистрибуции: `scripts/run.sh`

**Цель:** удобная точка входа для пользователей — один скрипт `./scripts/run.sh`,
