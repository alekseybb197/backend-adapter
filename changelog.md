...
## v0.8.4 (WIP — таблица использованных моделей на статус-странице WEBUI)<!-- WIP: записи по мере согласованных коммитов группы v0.8.4. -->## v0.8.3 (исправления WEBUI статус-страницы)
