...
## v0.8.5 (WIP — перечитывание конфига, синхронизация эндпоинтов, health-эндпоинты, Prometheus-экспортёр)

<!-- WIP: записи по мере согласованных коммитов группы v0.8.5. Версия не
