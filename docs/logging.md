...
и **JSON-файл результата опроса списка моделей** в LOGPATH (безусловный канал,
...
## JSON-файл результата опроса списка моделей в LOGPATH (v0.9.0)

**Безусловный наблюдательный канал** — результат опроса бэкенда на список
моделей пишется плоским JSON-файлом в корень `ADAPTER_DEBUG_LOGPATH` (рядом с
